...
export class CustomerComponent implements OnInit {
  ...
  fields: FormlyFieldConfig[] = [
    ...
    formly.requiredNumber('mobilenumber', 'Mobilenumber'),
  ];
  ...
  private filterValidCustomer() {
    function isValidCustomer(input: Customer | undefined): input is Customer {
...
function MobileNumber(arg0: string, MobileNumber: any): FormlyFieldConfig {
